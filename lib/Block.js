...
Block.getBlockValue = function getBlockValue(height) {
  var subsidy = 512 * util.COIN;
  if (height > 10080 && height < 120000) {
	var exponent=(height / 10080);
    for(i=0; i<exponent; i++){
        subsidy= subsidy * 47;
		subsidy= subsidy / 50;
    }
	if(subsidy < 5 * util.COIN){
		subsidy = 5 * util.COIN;
	}
  }
  else if (height >= 120000 && height < 130080) {
	  var subsidy = 250 * util.COIN;
	} 
    else if (height >= 130080 && height < 150000) {
      var subsidy = 250 * util.COIN;		
	  var exponent = ((height - 130080) / 1440);
      for(i=0; i<exponent; i++){
	...
	else if (height >= 150000 && height < 160080) {
		var subsidy = 25 * util.COIN;
	}
	else if (height >= 160080) {
	  var subsidy = 25 * util.COIN;
	  var exponent = ((height - 160080) / 10080);
      for(i=0; i<exponent; i++){
